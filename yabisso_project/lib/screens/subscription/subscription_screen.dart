...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  Widget _buildLogo() {
    return Container(
      ...
      child: const Icon(Icons.task_alt, size: 40, color: AppColors.primaryGreen),
    );
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Payer via WhatsApp', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                style: ElevatedButton.styleFrom(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.workspace_premium, size: 32, color: Color(0xFF1D9E75)),
            ),
            ...
            const SizedBox(height: 20),
            _buildPlanTile(ctx, 'Micro', '10 produits max', Icons.store_mall_directory_outlined, const Color(0xFFF5A623)),
            _buildPlanTile(ctx, 'Basic', '25 produits max', Icons.storefront, AppColors.primaryBlue),
            _buildPlanTile(ctx, 'Premium', '50 produits max', Icons.diamond_outlined, AppColors.primaryGreen),
            _buildPlanTile(ctx, 'Illimité', 'Produits illimités', Icons.all_inclusive, const Color(0xFF7C3AED)),
            const SizedBox(height: 8),
            TextButton(
  ...
  Future<void> _sendWhatsAppWithPlan(String plan) async {
    ...
    final message = Uri.encodeComponent(
        'Bonjour, je souhaite $action Yabisso Project $plan.$idText');
    if (mounted) {
