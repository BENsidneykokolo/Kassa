...
class PointsService {
  ...
  static int extractPointsAmount(String code) {
    ...
    if (parts.length != 4 || parts[0] != 'PTS') return 0;
  ...
  static Future<String?> validatePointsVoucher(String code, String boutiqueId) async {
    ...
    if (parts.length != 4 || parts[0] != 'PTS') {
      return 'Code invalide. Format attendu: PTS-XXXX-XXXX-XXXX';
    }
    ...
    final points = extractPointsAmount(trimmedCode);
    if (points <= 0) {
      return 'Montant de points invalide';
    }
    return null;
  }
}
